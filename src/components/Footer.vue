        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Pusat Supplier Tas dan Fashion Termurah di Kota Pontianak. Menyediakan berbagai macam aksesoris dan fashion untuk menyempurnakan fashionmu.
                    </p>
                    <div class="social">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        <i class="fa fa-map-marker"></i> Jalan Putri Dara Hitam No 3a
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Valencia Store</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
